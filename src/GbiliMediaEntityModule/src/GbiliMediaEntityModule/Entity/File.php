...
class File implements \GbiliMediaEntityModule\Entity\FileInterface
{
     ...
     * @TODO Medias should be moved out to a FileData entity (like MediaData Entity)
     *  this allows more abstract file interface
     * @ORM\OneToMany(targetEntity="\GbiliMediaEntityModule\Entity\MediaInterface", mappedBy="file", cascade={"persist"})
     */
    private $medias;
